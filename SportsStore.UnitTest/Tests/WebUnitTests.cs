...
namespace SportsStore.UnitTests.Tests
{
    ...
    public class WebUnitTests
    {
       ...
       [TestMethod]
        public void Can_Fliter_Products()
        {
            // Arrange
           ...
           //Arrange part 2 - create controller and make page size 3 items
           ProductController controller = new ProductController(mock.Object);
           controller.PageSize = 3;
       ...
       public void Can_Create_Categories()
       {
            ...
            string[] results = ((NavigationViewModel)target.Menu().Model).Categories.ToArray();
       ...
       public void Indicates_Selected_Category()
       {
            ...
            //Arrange - define category to be selected
            string category = "Apples";

            //Action
            string result = ((NavigationViewModel)target.Menu(category).Model).SelectedCategory;
