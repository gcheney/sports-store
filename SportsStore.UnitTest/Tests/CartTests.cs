...
namespace SportsStore.UnitTest.Tests
{
    ...
    public class CartTest
    {
        ...
        public void Can_Add_Quantity_For_Existing_Lines()
        {
            ...
            CartItem[] results = target.Items.OrderBy(c => c.Product.ProductID).ToArray();
        ...
        public void Can_Remove_Line()
        {
            ...
            // Assert
            Assert.AreEqual(target.Items.Where(c => c.Product == p2).Count(), 0);
        ...
        public void Can_Add_To_Cart()
        {
            ...
            Assert.AreEqual(cart.Items.ToArray()[0].Product.ProductID, 1);
        }
